...
val solverSpec = Spek.wrap {

    describe("2/ Solver") {

        describe("2.1/ TailRecursiveSolver.findSolution()") {
        ...
        describe("2.2/ State.availableMoves()") {
            ...
            it("return an Empty if state contains one filled Glass") {
                ...
                moves shouldContainsOnly Empty(0)
            }
            ...
            it("return an Fill if state contains one filled Glass") {
                ...
                moves shouldHaveSize 1
                moves shouldContainsOnly Fill(0)
            }
            ...
            it("return an Fill and an Empty if state contains one Glass neither empty nor fill") {
                ...
                moves shouldContainsAll listOf(Empty(0), Fill(0))
            }
        ...
        describe("2.4/ TailRecursiveSolver.nextStatesFromState()") {
            val solver = TailRecursiveSolver()
        ...
        describe("2.5/ TailRecursiveSolver.nextStatesFromCollection()") {
            val solver = TailRecursiveSolver()
        ...
        describe("2.6/ TailRecursiveSolver.allVisitedStates()") {
            val solver = TailRecursiveSolver()
            ...
            it("return list of new state with history") {
                ...
                states shouldContainsAll setOf(
                    "0/10".toState(),
                    "2/10".toState(),
                    "5/10".toState(),
                    "10/10".toState())
        ...
        describe("2.7/ TailRecursiveSolver.solve()") {
            val solver = TailRecursiveSolver()
